...
export default function ProductsActivePage() {
    ...
    return (
        <section className="list-products-active flex flex-col  justify-center items-center w-full">
            ...
            <h2 className="title-active font-extrabold text-6xl text-slate-300 w-full h-28 bg-slate-900 border-y border-slate-600 flex justify-center items-center p-4">
                Productos en venta
            </h2>
