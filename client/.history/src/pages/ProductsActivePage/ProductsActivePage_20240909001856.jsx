...
export default function ProductsActivePage() {
    ...
    return (
        <section className="list-products-active flex flex-col  justify-center items-center w-full">
            ...
            <div className="bg-slate-900 w-full h-24">
                <h2 className="title-active font-extrabold text-6xl text-slate-300 w-full h-24 bg-slate-900 border-y border-slate-600 flex justify-center items-center p-4">
                    Productos en venta
                </h2>
            </div>
