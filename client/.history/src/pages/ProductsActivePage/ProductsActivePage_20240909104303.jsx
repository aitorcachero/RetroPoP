            ...
            <div className="list-products__container-active w-full">
                <ul className="flex flex-1 flex-wrap gap-20 justify-center items-center">
                    ...
                    {products.length === 0 && !loading && (
                        <div className="flex justify-center items-center w-[350px] md:w-[800px] shadow-xl shadow-black bg-slate-900">
                            <h2 className="text-white text-xl  p-6 border border-slate-600 rounded-lg w-[350px] text-center">
