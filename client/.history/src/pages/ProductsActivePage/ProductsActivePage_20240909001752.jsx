...
export default function ProductsActivePage() {
    ...
    return (
        <section className="list-products-active flex flex-col  justify-center items-center w-full">
            ...
            <h2 className="title-active font-extrabold text-6xl text-slate-300 w-full h-24 bg-slate-900 border-y border-slate-600 flex justify-center items-center">
                Productos en venta
            </h2>
            <div className="list-products__container-active w-full">
                <ul className="flex flex-1 flex-wrap gap-20 justify-center items-center p-4">
                    {products &&
                        products
                            .filter(
                                (product) =>
