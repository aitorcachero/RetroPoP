        ...
        <>
            <div className=" flex flex-col md:flex-row md:gap-20 w-full mt-10">
                <aside className="  h-auto p-4 -mt-10 md:-mt-0 md:p-0 md:w-[500px]">
                    <form className="flex flex-col justify-center items-center rounded-xl bg-slate-900 border border-slate-600  md:ml-6  md:gap-10 h-auto py-4 gap-4 md:w-[500px]">
                        ...
                        <div className="w-full bg-slate-800 md:bg-slate-900 flex justify-center items-center">
                            <section className="container-aside__section_price gap-1 md:gap-4 md:h-[150px]">
                                ...
                                />
                                <p className="range-price__text  text-lg font-bold md:text-3xl text-slate-300 ">
                                    {filters?.actualPrice} €
                                </p>
                            </section>
                        </div>
