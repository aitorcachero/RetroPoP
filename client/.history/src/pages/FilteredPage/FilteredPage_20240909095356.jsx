    ...
    return (
        <>
            <div className=" flex flex-col md:flex-row md:gap-20 w-full mt-10">
                <aside className="  h-auto p-4 -mt-10 md:-mt-0 md:p-0 md:w-[500px]">
                    <form className="flex flex-col justify-center items-center rounded-xl bg-slate-900 border border-slate-600 gap-0  md:ml-6 md:p-10 md:gap-10 h-auto py-4 gap-4 md:w-[500px]">
                        ...
                        <div className="w-full bg-slate-800 flex justify-center items-center">
                            <section className="container-aside__section_price gap-1 md:gap-4 md:h-[150px]">
                        ...
                        <div className="w-full flex justify-center items-center">
                            <div className="container-aside__state gap-1 md:gap-4">
                        ...
                        <div className="w-full bg-slate-800 flex justify-center items-center">
                            <section className="container-aside__state gap-1 md:gap-4">
                                <h3 className="filter-h3 text-lg font-bold md:text-4xl">
                                    Localidad
                                </h3>
                                <input
                                    type="text"
