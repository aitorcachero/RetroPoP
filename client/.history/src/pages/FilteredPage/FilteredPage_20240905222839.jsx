...
export default function FilteredPage() {
    ...
    return (
        <>
            <div className="container flex flex-col md:flex-row md:gap-20 w-full">
                <aside className="  h-auto p-4">
                    <form
                        className="flex flex-col justify-center items-center rounded-xl bg-purple  md:ml-6 md:p-10 md:gap-10 h-auto py-4 gap-4"
                    ...
                    >
                        ...
                        <div className="container-aside__buttons">
                            <button
                                className="btn-reset w-48"
                                onClick={resetEventHandle}
                            >
                                Limpiar filtros
                            </button>
                            <button type="submit" className="btn-filter w-48">
                                Aplicar filtros
                            </button>
                        </div>
                    </form>
                ...
                <main className="w-full ">
                    <div className="w-full">
                        {products.length > 0 && (
                            <ul className="flex flex-wrap basis-2 gap-16 w-full">
                                {products
                                    .filter(
                                        (product) =>
                                            product.isSelled === 0 &&
