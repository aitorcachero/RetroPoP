                ...
                {filteredProducts && (
                    <>
                        <aside className="   p-4 -mt-10 md:-mt-0 md:p-0 md:w-[500px] flex flex-col justify-start items-center">
                            <form className="flex flex-col justify-center items-center rounded-xl bg-slate-900 border border-slate-600  md:ml-6  md:gap-10 h-auto py-4 gap-4 w-[350px] md:w-[500px] backdrop:blur-lg">
                        ...
                        <main className="w-full flex justify-center  ">
                            <div className="w-full flex flex-col items-center ">
                                <ul className="flex flex-wrap basis-2 gap-16 w-full justify-center mb-20">
