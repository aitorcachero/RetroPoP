        ...
        authUser && (
            <div className="flex flex-col justify-center items-center w-full ">
                ...
                <div className=" p-4 flex flex-col justify-center items-center w-full">
                    <form
                        className="mt-12 flex flex-col justify-start items-center bg-[#ffffffb7] border rounded-xl py-10 md:p-10 mb-12 gap-4 w-full md:w-[800px] bg-slate-950 text-white"
                        style={{
                            background:
                    ...
                    >
                        ...
                        <section className="profile-avatar-container flex flex-col md:flex-row p-4 gap-4 border border-white bg-slate-900">
                        ...
                        <section className="flex flex-col w-4/5 gap-4">
                            ...
                            <div className="profile-body-mail-container flex flex-col md:flex-row">
                                ...
                                <input
                                    type="text"
                                    className="rounded-lg h-12 border w-full md:w-96 border-black text-center bg-slate-900"
                                    value={email && email}
                                    disabled
                                />
                            </div>
