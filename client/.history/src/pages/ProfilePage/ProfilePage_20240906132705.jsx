    ...
    return (
        authUser && (
            <div className="flex flex-col justify-center items-center w-full">
                ...
                <form className="mt-12 flex flex-col justify-start items-center bg-[#ffffffb7] border rounded-xl py-10 md:p-10 mb-12 gap-4 min-w-[350px]">
                        ...
                        {showPopUp && (
                            <div className="popup min-w-[350px]">
                                ...
                                <button
                                    ...
                                    className="popup-button h-12 p-2 min-w-20 rounded-xl"
                                >
                                    Confirmar
                                </button>
                                <button
                                    onClick={cancelDelete}
                                    className="popup-button h-12 p-2 min-w-20 rounded-lg"
                                >
                                    Cancelar
                                </button>
                            </div>
