    ...
    return (
        authUser && (
            <div className="flex flex-col justify-center items-center w-full ">
                <div className="w-full h-12 flex flex-col justify-center items-center w-full">
                    <LateralBar />
                </div>
                <div className="w-full p-4">
                    <form className="mt-12 flex flex-col justify-start items-center bg-[#ffffffb7] border rounded-xl py-10 md:p-10 mb-12 gap-4 w-full md:w-[800px]">
                        ...
                        <section className="text-sm md:text-base mt-10 flex justify-center gap-4 md:w-4/5">
                            <button
                                ...
                                className="profile-footer-btn-delete h-12 p-2 md:w-48"
                            >
                                Borrar perfil
                            </button>
                            {showPopUp && (
                            ...
                            <button
                                ...
                                type="Submit"
                                className="profile-footer-btn-save h-12 p-2 md:w-48"
                            >
                                Guardar cambios
                            </button>
                        </section>
