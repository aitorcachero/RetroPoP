    ...
    return (
        authUser && (
            <div className="flex flex-col justify-center items-center w-full">
                ...
                <form className="mt-12 flex flex-col justify-start items-center bg-[#ffffffb7] border rounded-xl h-[900px]">
                    <h2 className="text-black font-extrabold text-5xl m-4">
                        Editar perfil
                    </h2>
