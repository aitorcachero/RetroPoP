    ...
    return (
        authUser && (
            <div className="flex flex-col justify-center items-center w-full">
                ...
                <form className="mt-12 flex flex-col justify-start items-center bg-[#ffffffb7] border rounded-xl py-10 md:p-10 mb-12 gap-4 min-w-[350px] md:w-[800px]">
                    <h2 className="text-slate-700 font-extrabold text-2xl md:text-5xl ">
                        Editar perfil
                    </h2>

                    <section className="profile-avatar-container flex flex-col md:flex-row p-4 gap-4">
                        ...
                        <div className="conditional-img fle h-12">
                            <label
                                htmlFor="file-input"
                                className="custom-file-label h-12"
                            >
                                <span className="profile-avatar-btn h-12">
                                    Subir imagen
                                </span>
                            </label>
                            <input
                    ...
                    <section className="flex flex-col w-4/5 gap-4">
                        <div className="profile-body-name-container flex flex-col md:flex-row gap-2 w-full">
                            ...
                            <input
                                type="text"
                                className="rounded-lg h-12 border border-black text-center w-full md:w-96"
                        ...
                        <div className="profile-body-mail-container flex flex-col md:flex-row">
                            ...
                            <input
                                type="text"
                                className="rounded-lg h-12 border w-full md:w-96 border-black text-center"
                                value={email && email}
                                disabled
                            />
                        </div>

                        <div className="profile-body-bio-container flex flex-col md:gap-10">
                            <h4 className="profile-body-bio-title">Bio</h4>
                            <textarea
                                onChange={(e) => setBio(e.target.value)}
                                value={bio && bio}
                                className="profile-body-bio-input w-full"
                                rows="5"
                            ></textarea>
                        </div>
                    </section>
                    <section className="text-sm md:text-base mt-10 flex gap-4">
                        <button
                            onClick={handleDeleteUser}
                            className="profile-footer-btn-delete h-12 p-2"
                        >
                            Borrar perfil
                        </button>
                        {showPopUp && (
                            <div className="popup min-w-[350px]">
                                <p className="popup-p">
                                    ¿Estás de que quieres eliminar tu usuario?
                                    ¡¡¡Esta acción no se puede deshacer!!!
                                </p>
                                <button
                                    onClick={confirmDelete}
                                    className="popup-button h-12 p-2 min-w-32 rounded-xl"
                                >
                                    Confirmar
                                </button>
                                <button
                        ...
                        <button
                            ...
                            type="Submit"
                            className="profile-footer-btn-save h-12 p-2"
                        >
                            Guardar cambios
                        </button>
                    </section>
