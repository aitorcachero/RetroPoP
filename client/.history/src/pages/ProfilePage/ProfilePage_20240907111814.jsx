                ...
                <div className=" p-4 flex flex-col justify-center items-center w-full">
                    ...
                    >
                        ...
                        <section className="profile-avatar-container flex flex-col md:flex-row p-4 gap-4 border border-slate-600 bg-slate-900">
                            ...
                            />
                            <div className="conditional-img flex w-[300px] md:w-auto h-16">
                                <label
                                    htmlFor="file-input"
                                    className="custom-file-label h-full flex justify-center items-center cursor-pointer md:_w-full"
                                >
                                    <span
                                        className={`${buttonStyle} h-full  text-center`}
                                    >
                                        Subir imagen
                                    </span>
                                </label>
                        ...
                        <section className="text-sm md:text-base mt-10 flex justify-center gap-4 md:w-4/5">
                            ...
                            {showPopUp && (
                                <div className="popup min-w-[350px] bg-slate-900 flex flex-col p-10 gap-4">
