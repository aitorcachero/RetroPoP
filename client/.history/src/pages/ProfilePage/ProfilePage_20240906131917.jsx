    ...
    return (
        authUser && (
            <div className="flex flex-col justify-center items-center w-full">
                ...
                <form className="mt-12 flex flex-col justify-start items-center bg-[#ffffffb7] border rounded-xl py-10 md:p-10 mb-12 gap-4 min-h-[350px]">
                    <h2 className="text-black font-extrabold text-xl md:text-5xl ">
                        Editar perfil
                    </h2>
