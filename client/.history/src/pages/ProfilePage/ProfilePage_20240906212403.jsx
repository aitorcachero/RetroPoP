        ...
        authUser && (
            <div className="flex flex-col justify-center items-center w-full ">
                ...
                <div className=" p-4 flex flex-col justify-center items-center w-full">
                    <form
                        className="mt-6 flex flex-col justify-start items-center bg-[#ffffffb7] border rounded-xl py-10 md:p-10 mb-12 gap-4 w-full md:w-[800px] bg-slate-950 text-white"
                        style={{
                            background:
