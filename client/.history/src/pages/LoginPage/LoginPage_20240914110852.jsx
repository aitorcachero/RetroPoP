                    ...
                    <div className="form-wrapper sign-up bg-slate-900 border border-slate-600 text-white">
                        <form action="" onSubmit={registerSubmit}>
                                ...
                                {registerObject.password.length > 2 && (
                                    <img
                                        onClick={() => {
                                            ...
                                            updateObject.passReg =
                                                !passVisible.passReg;
                                            setPassVisible(updateObject);
                                        }}
                                        className="eye"
                                        src={imgPassReg}
                                        alt="eye"
                            ...
                            <div className="input-group md:w-[320px] w-[220px]">
                                <input
                                    type={
                                        passVisible.passRepeatReg === false
                                            ? 'password'
                                            : 'text'
                                    }
                                ...
                                {registerObject.repeatedPass.length > 2 && (
                                    <img
                                        onClick={() => {
                                            ...
                                            updateObject.passRepeatReg =
                                                !passVisible.passRepeatReg;
                                ...
                                {loginObject.password.length > 2 && (
                                    <img
                                        onClick={() => {
                                            ...
                                            updateObject.passLog =
                                                !passVisible.passLog;
                                            setPassVisible(updateObject);
                                        }}
                                        className="eye"
                                        src={
                                            passVisible.passLog === true
                                                ? EYECLOSE
                                                : EYEOPEN
                                        }
                                        alt="eye"
