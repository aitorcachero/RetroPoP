...
import { buttonStyle } from '../../utils/const';
            ...
            <div className="booking-container-info">
                ...
                <footer className="booking-container-info-footer">
                    ...
                    <div className="booking-container-info-buttons ">
                        <button className={buttonStyle} onClick={rejectBooking}>
                            Rechazar
                        </button>
                        <button className={buttonStyle} onClick={acceptBooking}>
                            Aceptar
                        </button>
                        {showModal && (
                            <div className="popup-booking bg-slate-800">
