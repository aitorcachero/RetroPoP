...
export default function ReviewCard({ image, productName, resno }) {
    ...
    return (
        <div className="review-card-container">
            <article className="review-card flex flex-col md:flex-row p-10  md:gap-10 md:w-[800px] bg-slate-90 0 shadow-black shadow-xl">
                ...
                <section className="review-card__info md:w-1/2">
                    <form
                    ...
                    >
                        ...
                        <input
                            type="text"
                            className="review-title w-full rounded-xl text-base p-2"
                            placeholder="Titulo de la reseña"
                        />

                        <textarea
                            className="review-text w-full rounded-xl md:h-40 text-base min-h-20"
                            placeholder="Escribe tu reseña"
                        />

                        <select
                            className="stars-select w-full rounded-xl text-base p-2"
                            name="stars"
                            id="stars"
                        >
                        ...
                        <button
                            className="review-card__button py-2 px-6 w-full"
                            // onClick={handleStars}
                        >
                            Publicar
                        </button>
