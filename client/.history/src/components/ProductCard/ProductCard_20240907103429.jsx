...
export default function ProductCard({ image, productName, price, fav }) {
    ...
    return (
        <article className="w-[350px] md:w-[220px] h-[420px] md:h-[320px] bg-slate-900 flex flex-col justify-center items-center rounded-lg p-4 shadow-xl shadow-black border border-slate-600 cursor-pointer">
