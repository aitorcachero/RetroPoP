...
export default function ProductBigCard({ product }) {
    ...
    return (
        <div className="product-big-card p-4">
            <article className="product-page py-4  md:p-10">
                ...
                <div className="text-sm flex flex-col gap-4 m-2">
                    ...
                    <h3 className="text-center text-blue-500 text-4xl">
                        {product?.price}€
                    </h3>
                </div>
                <footer className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-row gap-6">
                        {product.isSelled === 0 &&
                            product.userSellerId !== authUser?.id && (
                                <button
                                    className="product-page__footer__buttons__buy text-sm md:text-lg p-4 min-w-20"
                        ...
                        {product.isSelled === 0 &&
                            product.userSellerId !== authUser?.id && (
                                <button
                                    className="product-page__footer__buttons__fav text-sm md:text-lg p-4 min-w-34"
