...
export default function ProductBigCard({ product }) {
    ...
    return (
        <div className="product-big-card p-4">
            <article className="product-page   my-4 md:min-w-[800px] bg-slate-900 shadow-xl shadow-black">
                ...
                <footer className="flex flex-col gap-6 w-full justify-center p-4 bg-slate-800">
                    ...
                    <div className="flex flex-row gap-6 w-[300px] md:w-full justify-around ">
                        {product.isSelled === 0 &&
                            product.userSellerId !== authUser?.id && (
                                <button
                        ...
                        {showPopUp && (
                            <div className="popup flex flex-col bg-slate-900 text-white gap-4 p-10 font-bold">
                                <p className="popup-p">
