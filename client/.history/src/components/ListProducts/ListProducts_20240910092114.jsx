    ...
    return (
        <section className="list-products">
            <div className="list-products__container w-full flex flex-col justify-center items-center">
                <div className="w-[600px] border border-slate-600    z-50">
                    <input
                        type="text"
                        className="w-full outline-none border rounded-lg p-2 text-center bg-transparent backdrop-blur-md text-white"
                    />
                </div>
