    ...
    return (
        <>
            <nav className="navbar shadow-xl shadow-black bg-slate-900 bg-transparent backdrop-blur-md ">
                ...
                <input
                    type="text"
                    className="search-form md:w-1/2 w-48 h-12 md:h-14 bg-transparent border border-slate-600 backdrop-blur-md"
                ...
                {!loading &&
                    (!authUser ? (
                        <img
                            className="user w-full h-full md:w-14 md:h-14 border-2 border-slate-600"
                            src="/icons/login.png"
