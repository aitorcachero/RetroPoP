...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="navbar shadow-xl shadow-black">
                <img
                ...
                <input
                    type="text"
                    className="search-form md:w-1/2 w-64 h-12 md:h-14"
                ...
                {authToken && (
                    <NavLink to="/upload" className="upload-product-nav">
                        <button
                            className="upload-product md:w-[230px] md:h-[60px] p-2 text-xs md:text-lg"
                            style={{ cursor: 'pointer' }}
                        >
                            <img
