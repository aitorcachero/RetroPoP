...
const ProductCreateForm = () => {
    ...
    return (
        <div className="product-create-form-container">
            <form
                className="flex flex-col justify-center items-center gap-4 p-6 mt-10 bg-slate-900 shadow-xl shadow-black border border-slate-700 "
            ...
            >
                ...
                <div className="flex flex-row text-xs md:text-base md: gap-10 ">
                    <section className="product-create-form__left">
                        <h4 className="product-create-form__title text-start">
                            Nombre del producto
                        </h4>
                        <h4 className="product-create-form__title text-left">
                            Categoría
                        </h4>
