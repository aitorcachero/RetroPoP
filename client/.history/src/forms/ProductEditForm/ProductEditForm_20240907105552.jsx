...
const ProductEditForm = ({ id }) => {
    ...
    return (
        <div className="w-full p-2 flex justify-center items-center">
            <form
                className="flex flex-col justify-center items-center gap-4 p-6 mt-10 bg-slate-900 shadow-xl shadow-black border border-slate-700 md:px-20 text-xs md:text-base md:w-[600px]"
            ...
            >
                ...
                <div className="flex flex-row justify-around items-center gap-4 text-start">
                ...
                <div className="img-prev-container">
                    <img
                        ...
                        className="rounded contain w-20 md:w-36"
                    />
                    <img
                    ...
                    {previewUrl && (
                        <img
                            className="w-20 md:w-36 contain"
                            src={previewUrl}
