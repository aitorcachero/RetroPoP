...
const ProductEditForm = ({ id }) => {
    ...
    return (
        <div className="w-full p-2 flex justify-center items-center">
            <form
                className="flex flex-col justify-center items-center gap-4 p-6 mt-10 bg-slate-900 shadow-xl shadow-black border border-slate-700 md:px-20 text-xs md:text-base md:w-2/3"
